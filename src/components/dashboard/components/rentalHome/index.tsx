...
export const RentalHome = () => {
  return (
    <div className="my-14 lg:px-6 max-w-[95rem] mx-auto w-full flex flex-col gap-4">
      ...
      <h3 className="text-xl font-semibold">Rental Home</h3>
      {/* <div className="flex justify-between flex-wrap gap-4 items-center">
        ...
        <div className="flex flex-row gap-3.5 flex-wrap">
          <Button
            ...
            className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition duration-300"
          >
            Export to CSV
          </Button>
        </div>
      ...
      <div className="max-w-[95rem] mx-auto w-full bg-gray-100 dark:bg-gray-800 rounded-lg">
        <div className="container mx-auto mb-7">
          ...
          <div className="flex flex-wrap px-6 py-1">
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 py-2">
              <p className="font-bold text-gray-700 dark:text-gray-300">Pet</p>
