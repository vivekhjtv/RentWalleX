                  ...
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-4">
                      <label
                        ...
                        className="block text-sm font-medium leading-6 text-gray-900 dark:text-white"
                      >
                        How do you currently pay your rent ( E-transfer, Bank,
                        Cash, Cheque):
                      </label>
                      <div className="mt-2">
                        <select
                  ...
                  >
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                      ...
                      <div className="aggrement sm:col-span-4">
                        ...
                        />
                        I authorize Rentwallex to verify the information
                      ...
                      <div className="aggrement sm:col-span-4">
                        ...
                        process my rent financing application and provide
                        related services.
                      </div>
                      <div className="aggrement sm:col-span-4">
                        <input
                          ...
                          onChange={handleCheckboxChange}
                        />
                        I acknowledge that Rentwallex may contact me via email,
                        phone, or SMS for account-related purposes
                      </div>
                      <div className="aggrement sm:col-span-4">
                        <input
                          type="checkbox"
                      ...
                      <div className="sm:col-span-4">
                        ...
                        submitting. Upon receipt of your application, our team
                        will review it and contact you to proceed with the
                        onboarding process.
                      </div>
                    </div>
                    <div>
              ...
              {currentStep === 5 && (
                <>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    Thank you for choosing Rentwallex. Please be patient untill
                    our team review your application.
                  </p>
                </>
              )}
            </form>
